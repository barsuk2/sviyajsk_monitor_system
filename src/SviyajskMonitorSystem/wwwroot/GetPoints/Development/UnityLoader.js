...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'GetPoints.data';
    var REMOTE_PACKAGE_BASE = 'GetPoints.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 8067478;
      var PACKAGE_UUID = 'd548b511-455a-4d6f-b922-fd6a198fbf1a';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 3436586, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(3436586, 3436607, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(3436607, 3437049, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(3437049, 6543793, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(6543793, 8039853, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(8039853, 8067478, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_GetPoints.data');

    };
    Module['addRunDependency']('datafile_GetPoints.data');
