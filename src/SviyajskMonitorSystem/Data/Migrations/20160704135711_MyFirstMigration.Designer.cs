...
namespace SviyajskMonitorSystem.Data.Migrations
{
    ...
    [Migration("20160704135711_MyFirstMigration")]
    partial class MyFirstMigration
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SviyajskMonitorSystem.Models.ElementType", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SviyajskMonitorSystem.Models.Place", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SviyajskMonitorSystem.Models.Element", b =>
                {
                    b.HasOne("SviyajskMonitorSystem.Models.Place", "place")
                        .WithMany("elements")
                        .HasForeignKey("placeid");

                    b.HasOne("SviyajskMonitorSystem.Models.ElementType", "type")
                        .WithMany("elements")
