...
namespace SviyajskMonitorSystem.Data.Migrations
{
    ...
    [Migration("20170807115222_SampleMigration")]
    partial class SampleMigration
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SviyajskMonitorSystem.Models.Sample", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("PpersonId");

                    b.Property<int?>("SamplePlaceId");
                    ...
                    b.HasIndex("PpersonId");

                    b.HasIndex("SamplePlaceId");
            ...
            modelBuilder.Entity("SviyajskMonitorSystem.Models.Analyze", b =>
                {
                    ...
                    b.HasOne("SviyajskMonitorSystem.Models.Sample", "Sample")
                        .WithMany("Analyzes")
            ...
            modelBuilder.Entity("SviyajskMonitorSystem.Models.Sample", b =>
                {
                    b.HasOne("SviyajskMonitorSystem.Models.Person", "Pperson")
                        .WithMany()
                        .HasForeignKey("PpersonId");

                    b.HasOne("SviyajskMonitorSystem.Models.Point", "SamplePlace")
                        .WithMany("samples")
                        .HasForeignKey("SamplePlaceId");
