...
namespace SviyajskMonitorSystem.Data.Migrations
{
    ...
    [Migration("20160711140908_second")]
    partial class second
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SviyajskMonitorSystem.Models.DecoreElementRegion", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SviyajskMonitorSystem.Models.Spectr", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SviyajskMonitorSystem.Models.ChemistryElMassDole", b =>
                {
                    ...
                    b.HasOne("SviyajskMonitorSystem.Models.Spectr", "spectr")
                        .WithMany("massdoles")
                        .HasForeignKey("spectrid");
                });
            ...
            modelBuilder.Entity("SviyajskMonitorSystem.Models.Point", b =>
                {
                    b.HasOne("SviyajskMonitorSystem.Models.CulcherObject", "building")
                        .WithMany()
                    ...
                    b.HasOne("SviyajskMonitorSystem.Models.DecoreElementRegion", "decoreregion")
                        .WithMany()
                        .HasForeignKey("decoreregionid");
            ...
            modelBuilder.Entity("SviyajskMonitorSystem.Models.Spectr", b =>
                {
                    ...
                    b.HasOne("SviyajskMonitorSystem.Models.Photo", "photo")
                        .WithMany()
