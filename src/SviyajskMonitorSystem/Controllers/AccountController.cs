...
namespace SviyajskMonitorSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //            return RedirectToAction(nameof(ShowPointsController.Index), "ShowPoints");
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> ConfirmEmail(string userId, string password, string code)
        {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "Сброс пароля",
                   "Для восстановления доступа к системе перейдите по ссылке: <a href=\"" + callbackUrl + "\">Сбросить пароль</a>");
                return View("ForgotPasswordConfirmation");
            }
