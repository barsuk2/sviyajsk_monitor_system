...
namespace SviyajskMonitorSystem.Controllers
{
    public class OrganizationsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,name,CreatedById,UpdatedById,CreatedAt,LastUpdatedAt")] Organization organization)
        {
        ...
        public IActionResult GetOrganizationsJson()
        {
            return Json(_context.Organizations.Include(org=>org.Storages));
        }
    }
}
